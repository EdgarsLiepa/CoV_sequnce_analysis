...
import csv
import sys
import pickle # used in saveSequenceObject()

def saveSequenceObject(object):
    # Save result object in a file

    with open('sequence_data.pkl', 'wb') as outp:
        pickle.dump(object, outp, -1)
...
def main():
    ...
    saveSequenceObject(mutationList)

    print("AA substitition counts saved at mutations.csv and Biopython object at sequence_data.pkl")
